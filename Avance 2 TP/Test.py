...
class MyTestCase(unittest.TestCase):
    def test_enviar_solicitud(self):
        ...
        Marti.enviarSolicitud(456456)
        Felix.aceptarSolicitud(Marti)
        Jose.enviarSolicitud(123123)
        self.assertEqual("El contacto ya existe dentro de tus contactos", Felix.enviarSolicitud(123123))
        self.assertEqual("Ya enviaste una solicitud a este contacto", Jose.enviarSolicitud(123123))
