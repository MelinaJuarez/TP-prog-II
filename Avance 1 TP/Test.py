...
class MyTestCase(unittest.TestCase):
    def test_enviar_solicitud(self):
        ...
        Marti.enviarSolicitud(Felix)
        Felix.aceptarSolicitud(Marti)
        Jose.enviarSolicitud(Marti)
        self.assertEqual("El contacto ya existe dentro de tus contactos", Felix.enviarSolicitud(Marti))
        self.assertEqual("Ya enviaste una solicitud a este contacto", Jose.enviarSolicitud(Marti))
