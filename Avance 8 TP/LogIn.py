...
ciudadanos_bloqueados_usuarios = AppDataBase.ciudadanos_bloqueados_usuarios
                    ...
                    with open("Usuarios.csv", "w") as file_us:
                        ...
                        for row in data:
                            if row[3] == "Cuil":
                                ...
                                if int(row[3]) == ciudadanos[eleccion_c-1].get_CUIL():
            ...
            with open("Usuarios.csv", "r") as file_us_r:
                ...
                for row in file_us_r:
                    if len(row) != 0 and row[3] != "Cuil":
                        if int(row[3]) == ciudadanos_usuarios[usuarios.index(key1)].get_CUIL():
                            if row[4] == "Bloqueado":
