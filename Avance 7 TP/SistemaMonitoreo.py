...
class SistemaMonitoreo:
    ...
    def __init__(self):
        self.__sensores = AppDataBase.sensores
        self.__eventos = AppDataBase.eventos
        self.__usuarios_ciudadanos = AppDataBase.ciudadanos_usuarios
    ...
    """def crear_tablero_de_eventos(self):
        eventos_impactantes = self.eventos_mas_impactantes()
        data_list = 
        with open("Tablero_Eventos.csv", "w") as file_tab:
            file_w = csv.writer(file_tab)
            data = [["Eventos", "Barrio", "Top impacto", "Top Concurrencia"],
...
print(EventIt.ordenar_eventos_de_barrio())"""
