...
from Error import RegisterError, NoContactError, ContactError, SolicitudError, UserError
...
class CiudadanoUsuario:
    ...
    def aceptarSolicitud(self, ciudadano):
        if ciudadano in self.get_solicitudes_recibidas():
            self.__solicitudes_recibidas.remove(ciudadano)
            self.__contactos.append(ciudadano)
...
class MyTestCase(unittest.TestCase):
    def test_registrarse(self):
        Marti = Ciudadano("Martina Sipowicz", 78945, 654987)
        Felix = Ciudadano("Felix Vischi", 45612, 123456)
        Jose = Ciudadano("Josefina Fernandez", 95115, 753357)
    ...
    def test_enviar_solicitud(self):
        ...
        Felix = Ciudadano("Felix Vischi", 45612, 123456)
        Jose = Ciudadano("Josefina Fernandez", 95115, 753357)
        Anastasio = Ciudadano("Anastasio Josefino", 74126, 102358)
        ...
        self.assertEqual("El usuario indicado no existe", Jose_Usuario.enviarSolicitud(20000))
    ...
    def test_fake_denegar_solicitud(self):
        ...
        Felix = Ciudadano("Felix Vischi", 45612, 123456)
        Jose = Ciudadano("Josefina Fernandez", 95115, 753357)
        Charly = Ciudadano("Charly Garcia", 41036, 840369)
        Gertrudis = Ciudadano("Gertrudis Milanesa", 41206, 985206)
        Anastasio = Ciudadano("Anastasio Josefino", 74126, 102358)
        Rodri = Ciudadano("Rodrigo Peralta", 45035, 741650)
        Marti_Usuario = Marti.registrarse()
        Felix_Usuario = Felix.registrarse()
        Jose_Usuario = Jose.registrarse()
        ...
        Marti_Usuario.enviarSolicitud(102358)
        ...
        self.assertEqual("Martina Sipowicz ha sido bloqueado/a", Anastasio_Usuario.fakedenegarSolicitud(Marti_Usuario))
